...
```{r ndvi_precip_z}
z_tab$ndvi_prcp %>%
    pander::pander("Study period deviations from historical NDVI and YTD precipitation across burn seasons.") 
```
...
```{r weather_season_z}
z_tab$wxd %>%
    pander::pander("Study period deviations from historical fire weather across burn seasons.") 
```
...
```{r historical_phenology_z}
z_tab$hist %>%
    pander::pander("Study period deviations from two historical periods of fuel conditions and fire weather across burn seasons.") 
```
